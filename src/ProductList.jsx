...
import cart from "./assets/img/iconmonstr-cart.png";
...
function ProductList({ onHomeClick }) {
  ...
  const cartQuantity = cartItems.reduce((sum, item) => sum + item.quantity, 0); // Total items count
  ...
  useEffect(() => {
    for (const addedItems in addedToCart) {
      const itemToFind = cartItems.find((item) => item.name === addedItems);
      ...
      <div className="navbar">
        ...
        <div className="cart-div">
          <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
            ...
            {cartQuantity > 0 ? (
              <h4 className="cart_quantity_count">{cartQuantity}</h4>
            ) : null}
            {/* </h1> */}
          </a>
        </div>
